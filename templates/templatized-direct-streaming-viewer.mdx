...
{{COMPANY_NAME}}'s Player API can either be used as a standalone JavaScript API or as a React Component Library.
...
**IMPORTANT**: You will also need _your domain_ which will be provided by {{COMPANY_NAME}}.
