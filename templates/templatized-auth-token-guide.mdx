...
In previous documents, we've explained what options you have for authorization and how to set up the token-based system we use at {{COMPANY_NAME}}.  Now we need to help you understand how the **authToken** is used in the browser.  
