...
const customCssPath = path.join(__dirname, `src/css/${vendor}/${company}/custom.css`);
...
const config: Config = {
  ...
  presets: [
    [
      ...
      {
        docs: {
          sidebarPath: require.resolve(`./sidebars/${vendor}-${company}.ts`),
          routeBasePath: '/',
          path: 'docs',
        ...
        theme: {
          customCss: [
            ...
            ...(customCssExists ? [require.resolve(`./src/css/${vendor}/${company}/custom.css`)] : []),
          ],
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          type: 'docSidebar',
          sidebarId: `${vendor}${company}Sidebar`,
          position: 'left',
          label: 'Docs',
        },
